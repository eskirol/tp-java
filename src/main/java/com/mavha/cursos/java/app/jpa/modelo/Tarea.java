...
public class Tarea {
    ...
    @Temporal(TemporalType.DATE) private Date fechaInicio; //TODO 1.6 definir tipo temporal
    @Column(name = "FECHA_FIN")   
    @Temporal(TemporalType.DATE) private Date fechaFin; //TODO 1.6 definir tipo temporal
